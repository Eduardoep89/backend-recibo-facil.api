    ...
    public partial class Inicial3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItensRecibo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItensRecibo_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItensRecibo_Recibos_ReciboId",
                        column: x => x.ReciboId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItensRecibo_ProdutoId",
                table: "ItensRecibo",
                column: "ProdutoId");

            migrationBuilder.CreateIndex(
                name: "IX_ItensRecibo_ReciboId",
                table: "ItensRecibo",
                column: "ReciboId");
